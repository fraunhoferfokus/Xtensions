...
you have to compile the library yourself. Please have a look at the [Build](#build) section.
...
test class:
[Showcase.xtend](/tests/de.fhg.fokus.xtensions.tests/src/de/fhg/fokus/xtensions/Showcase.xtend)
...
It is also possible to map an iterable to a primitive iterable (see [Primitve Iterables / From Iterables](#from-iterables)).
