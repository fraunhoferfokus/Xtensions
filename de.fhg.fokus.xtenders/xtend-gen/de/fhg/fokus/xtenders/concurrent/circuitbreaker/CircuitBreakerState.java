...
public interface CircuitBreakerState {
   ...
   */
  public abstract boolean isCallPossible(final String circuitBreakerName);
   ...
   */
  public abstract void successfulCall(final String circuitBreakerName);
  
  /**
   * Reports that a stated call was not successful. Based on this feedback,
   * the {@link #isCallPossible()} may decide to allow future calls or not.
   */
  public abstract void exceptionalCall(final Throwable ex, final String circuitBreakerName);
}
