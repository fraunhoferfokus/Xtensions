...
interface LongIterable extends Iterable<Long> {
	 ...
	 * The default implementation returns a stream uses{@link PrimitiveIteratorExtensions#streamRemaining(OfLong)} with the iterator from{@link #iterator()} to construct the resulting stream. It is highly
